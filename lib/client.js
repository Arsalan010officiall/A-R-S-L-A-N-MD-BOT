...
try {
    ...
    console.log("🌍 Connected to the ARSLAN DB");
} catch {
...
let cc = Config.sessionName.replace(/ARSLAN;;;/g, "").replace(/BLACK;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
